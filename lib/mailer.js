// Outbound email via Resend (resend.com), used for account emails
// (verification, password reset). Chosen over Gmail SMTP because Google
// increasingly blocks App Password creation for newer accounts regardless
// of 2-Step Verification status.
//
